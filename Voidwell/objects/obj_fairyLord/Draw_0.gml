...
flapAngle = animcurve_channel_evaluate(wingFlapChannel, flapProgress) * 70;

draw_sprite_ext(spr_wing, 0, x - sprite_width * .34, y, image_xscale * 4, -image_yscale * 4, -flapAngle + 180, image_blend, image_alpha);
draw_sprite_ext(spr_wing, 0, x + sprite_width * .34, y, image_xscale * 4, image_yscale * 4, flapAngle, image_blend, image_alpha);
