...
global.tileSprites =                 [spr_tile,                 spr_tile,                spr_tileCrystal,         spr_tile,                    spr_tileWood,            spr_tileFlesh,        spr_tileBanana,          spr_tileExplosive,  spr_tileMetal,                                                                        spr_tileWood, spr_tileWood, spr_tileFlesh];
global.tileColors =                  [c_black,                  c_green,                 c_aqua,                  #884411,                     #cbb29f,                 #ff8888,              #ffff00,                 #ff4014,            #393939,                                                                              #aaaaaa, #555555, #ffe0f8];
global.tilePlaceSounds =             [snd_placeBlock,           snd_placeBlock,          snd_placeBlock,          snd_placeBlockMud,           snd_placeBlock,          snd_placeBlockMud,     snd_banana,             snd_placeBlock,     snd_placeBlockMetal,                                                                  snd_placeBlock, snd_placeBlock, snd_placeBlock];
global.tileBreakSounds =             [snd_breakBlockWood,       snd_breakBlockGrass,      snd_breakBlockCrystal,   snd_breakBlockMud,          snd_breakBlockWood,      snd_breakBlockWood,    snd_banana,             snd_breakBlockWood, snd_breakBlockMetal,                                                                  snd_breakBlockStone, snd_breakBlockStone, snd_breakBlockCrystal];
global.tileStepSounds =              [snd_stepSoundStone,[snd_stepSoundMud1, snd_stepSoundMud2],snd_stepSoundStone,snd_stepSoundDirt,     snd_stepSoundStone, [snd_stepSoundMud1, snd_stepSoundMud2], snd_banana,      snd_stepSoundStone, [snd_stepSoundMetal1, snd_stepSoundMetal2, snd_stepSoundMetal3, snd_stepSoundMetal4], snd_stepSoundStone, snd_stepSoundStone, snd_stepSoundStone];
global.tileFallSounds =              [snd_explosion,            snd_explosion,           snd_fallOntoCrystal,      snd_fallOntoMud,            snd_explosion,           snd_fallOntoMud,       snd_fallOntoMud,          snd_explosion,    snd_placeBlockMetal,                                                                  snd_explosion, snd_explosion, snd_fallOntoCrystal];
global.tileFallDamage =              [0,                        .6,                      2.2,                       .8,                          1.2,                     .5,                    .75,                    .7,                 1.3,                                                                                  1.4, 1.6, .1];
