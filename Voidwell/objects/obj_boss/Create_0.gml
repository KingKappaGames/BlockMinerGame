...
drawHealthBar = function() {
	...
	if(hitFlash > 0) {
		draw_rectangle_color(_viewW * .2, _viewH * .895, _viewW * .8, _viewH * .905, c_white, c_white, c_white, c_white, true);
		draw_rectangle_color(_viewW * .5 - _viewW * .3 * _health, _viewH * .915, _viewW * .5 + _viewW * .3 * _health, _viewH * .885, c_white, c_white, c_white, c_white, false);
	} else {
